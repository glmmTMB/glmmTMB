...
\newcommand{\btheeta}{\boldsymbol \theta}
\newcommand{\inv}[1]{{#1}^{-1}}
...
* see `termwise_nll`; not quite sure how we would work with precision matrices/specify a MVN log-likelihood with precision rather than corr Cholesky factor supplied??
