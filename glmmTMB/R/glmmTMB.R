...
##' @export
##' @examples
##' (m1 <- glmmTMB(count~spp + mined + (1|site), zi=~spp + mined+ (1|site), family=poisson, Salamanders))
##' summary(m1)
##' ## Not run:
##' ## Negative binomial model
##' (m2 <- glmmTMB(count~spp + mined + (1|site), zi=~spp + mined, family=nbinom2, Salamanders))
##' ## Dispersion model
