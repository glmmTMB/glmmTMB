...
##' @param nAGQ number of adaptive Gauss-Hermite quadrature points to use in the Laplace approximation of the marginal likelihood. The default value is 1, which corresponds to the standard Laplace approximation. Higher values (e.g., 2 or 3) may improve accuracy for some models, but will increase computation time.
##' @details
