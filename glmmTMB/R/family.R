...
##'           The dispersion model gives the relationship variance=mu*phi.}
##'      \item{genpois}{is the generalized Poisson distribution(Consul & Famoye 1992).
##'           The dispersion model gives the relationship variance=mu*exp(eta).
##'           (Here we avoid using "phi" with a different meaning from the above citation.)}
