...
test_that("truncated", {
    ...
    #Genpois
    tgp1 <<- glmmTMB(z_tp ~1, tcmpdat, family="truncated_genpois")
    ...
    #Compois
    tcp1 <<- glmmTMB(z_tp ~1, tcmpdat, family="truncated_genpois")
    tcpdat <<- data.frame(y=simulate(tcp1)[,1])
    tcp2 <<- glmmTMB(y ~1, tcpdat, family="truncated_genpois")		
