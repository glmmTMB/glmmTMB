...
Notice that we call `simGroup` `r ngrp` times rather than drawing from a (`r ngrp`*25)-variate normal distribution because observations beloging to different groups are uncorrelated with each other.
