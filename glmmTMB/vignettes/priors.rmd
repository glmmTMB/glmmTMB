...
The code for extracting CIs is a little bit ugly (because profile confidence intervals aren't
...
t3B <- tibble(estimate = attr(VarCorr(gmod_glmmTMB_p)$cond$Site, "stddev"),
              conf.low = NA,
              conf.high = NA)
