...
The data was originally published in @price_effects_2016 and was aquired from Dryad (@dryad_5m8f6).


# Preliminaries
```{r setup, include=FALSE, message=FALSE}
library(knitr)
knitr::opts_chunk$set(echo = TRUE, cache=FALSE, fig.width = 7)
...
*Figure 2 -- Estimated abundance ignoring correlation.* Points represtent site-specific average counts. Error bars represent the 95% Wald-type confidence intervals for the predicted average count.
