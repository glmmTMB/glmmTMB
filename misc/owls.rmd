...
```
In this appendix, we analyze counts of begging behavior by owl nestlings. This example previously appeared in @zuur_mixed_2009 and @bolker_strategies_2013 and was originally published by @roulin_nestling_2007. **More description...**
...
Here we fit the model with zero-inflation depending on some of the predictor variables. We can no longer use `glmmADMB` ...
